      ...
      body: SafeArea(
        child: ListView(
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Text("Tiến độ hoàn thành", style: TextStyle(fontSize: 22)),
                  SizedBox(height: MediaQuery.of(context).size.height * 0.01),
            ...
            buildTitle("ĐÃ MỞ KHÓA"),
            achievementUnlocked(
              context: context,
              color: CupertinoColors.systemGreen,
              title: "Tân học viên",
              sub: "Hoàn thành buổi học đầu tiên",
              heightImage: 30,
            ...
            achievementUnlocked(
              ...
              title: "Chăm học",
              sub: "Tạo được 5 bộ thẻ",
              heightImage: 30,
              image: "assets/icons/book.png",
              dayUnlock: "30/12/2024"
            ),
            buildTitle("CHƯA MỞ KHÓA"),
            achievementNotUnlocked(
              ratio: 0.3,
              context: context,
              color: CupertinoColors.systemYellow,
              title: "Nhiều sao",
              sub: "Đạt 100% trong 5 bộ thẻ",
              heightImage: 30,
            ...
            achievementNotUnlocked(
              ...
              color: CupertinoColors.systemYellow,
              title: "Thần tốc",
              sub: "hoàn thành 100 flashcard trong 1 ngày",
              heightImage: 30,
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  child: Row(
                    ...
                    children: [Icon(CupertinoIcons.check_mark_circled,color: CupertinoColors.black,), Text("Đã mở khóa : ${dayUnlock}",style: TextStyle(color: CupertinoColors.black),)],
                  ),
                ),
                SizedBox(height: MediaQuery.of(context).size.height * 0.01),
                ElevatedButton(
            ...
            child: Column(
              children: [
                ...
                ElevatedButton(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [Icon(CupertinoIcons.lock), Text("Tiến độ ${(ratio * 100).round()}%")],
                  ),
                ),
                SizedBox(height: MediaQuery.of(context).size.height * 0.01),
                ElevatedButton(
